...
const MOCK_ANOMALIES: DetectedAnomaly[] = [
    {
        ...
        equipmentType: 'Paint',
        severity: 'critical',
        description: 'Humidity sensor readings erratic: 45% -> 78% -> 52% in 10 minutes. Paint adhesion quality at risk. Possible sensor failure or HVAC malfunction in booth zone.',
        detectedAt: '2026-02-09T09:15:00Z',
        suggestedWorkflowId: 'repo-7',
        suggestedWorkflowName: 'Paint Booth Temperature Control',
        suggestedAction: 'Isolate booth, inspect humidity sensors and HVAC ducting',
        status: 'pending',
        confidence: 0.94,
        remainingUsefulLife: '6 hours',
        estimatedCostIfIgnored: 45000,
        digitalTwinAssetId: 'paint-booth-7',
    },
    {
        id: 'anomaly-2',
        factoryId: 'factory-munich',
