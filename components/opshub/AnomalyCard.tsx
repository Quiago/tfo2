            ...
            <div className="p-3">
                ...
                <div className="flex items-center gap-2 mt-3 pt-2">
                    <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-zinc-800 hover:bg-emerald-900/30 hover:text-emerald-400 hover:border-emerald-900/50 border border-zinc-700 rounded transition-all"
                    >
