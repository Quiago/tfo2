// /components/features/workflow-builder/VoiceInput.tsx
'use client'
...
export function VoiceInput({ className = '' }: VoiceInputProps) {
  ...
  const handleMicPress = useCallback(() => {
    if (isVoiceRecording) {
      ...
      setTimeout(() => {
        ...
        setVoiceTranscript(
          'If this Bosch pump sounds like gravel, it has air in the system. Purge it and create a maintenance ticket.'
        )
  ...
  }, [isVoiceRecording, setVoiceRecording, setVoiceTranscript, setConfirmationCard, setIsProcessing])
